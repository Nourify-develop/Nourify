                ...
                {showOptions === row.id && (
                  <div className="absolute -left-10 z-10 " >
                    <div className="bg-white rounded-[15px] shadow-md w-[100px] h-auto  flex flex-col  items-start font-medium">
                      <button className="text-primary-2 w-full duration-300 hover:bg-gray-1 p-3 text-left">Edit</button>
                      <button className="text-[#EB4E4E] w-full transition duration-300 hover:bg-gray-1 p-3 text-left ">Delete</button>
                    </div>
                  </div>
                )}
              </td>
