...
const Limoffer = () => {
  return (
    <Wrapper className=" bg-white">
      <div className="text-center gap-2 md:text-left flex md:flex-row bg-gradient-to-r from-gray-900 via-green-700 to-green-600 rounded-3xl justify-between items-center overflow-hidden md:overflow-visible ">
